    ...
    public partial class BookStoresDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=108.174.195.137;Initial Catalog=BookStoresDB;Integrated Security=False;Persist Security Info=False;User ID=sa;Password=Kbaappserver+6;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>(entity =>
            {
                ...
                entity.HasOne(d => d.Pub)
                    ...
                    .HasConstraintName("FK__Book__pub_id__3C69FB99");
            });
            ...
            modelBuilder.Entity<BookAuthor>(entity =>
            {
                ...
                entity.HasOne(d => d.Book)
                    ...
                    .HasConstraintName("FK__BookAutho__book___3D5E1FD2");
            });
            ...
            modelBuilder.Entity<Publisher>(entity =>
            {
                entity.HasKey(e => e.PubId)
                    .HasName("PK__Publishe__2515F2221793AC74");
            ...
            modelBuilder.Entity<Sale>(entity =>
            {
                ...
                entity.HasOne(d => d.Book)
                    .WithMany(p => p.Sale)
                    .HasForeignKey(d => d.BookId)
                    .HasConstraintName("FK__Sale__book_id__3F466844");

                entity.HasOne(d => d.Store)
                    .WithMany(p => p.Sale)
                    .HasForeignKey(d => d.StoreId)
                    .HasConstraintName("FK__Sale__store_id__403A8C7D");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasOne(d => d.Job)
                    ...
                    .HasConstraintName("FK__User__job_id__412EB0B6");
